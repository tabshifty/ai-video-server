...
describe('toolbox pages', () => {
  ...
  it('keeps the ED2K download workbench anchored on source metadata and fixed detail sections', () => {
    ...
    expect(ed2kDownloadTool).toContain('source_link')
    expect(ed2kDownloadTool).toContain('resource_hash')
    expect(ed2kDownloadTool).toContain('expected_files')
    expect(ed2kDownloadTool).toContain('running_files')
    expect(ed2kDownloadTool).toContain('failed_files')
    expect(ed2kDownloadTool).toContain('completed_files')
    expect(ed2kDownloadTool).toContain('showExpectedFiles')
    expect(ed2kDownloadTool).toContain('showFileSection')
    expect(ed2kDownloadTool).toContain('fileSectionTitle')
    expect(ed2kDownloadTool).toContain('currentStatusDescription')
    expect(ed2kDownloadTool).toContain('file-item__main')
    expect(ed2kDownloadTool).toContain('来源标识')
    expect(ed2kDownloadTool).toContain('预期文件信息')
    expect(ed2kDownloadTool).toContain('最终结果清单')
    expect(ed2kDownloadTool).not.toContain('parseEd2kLinks')
