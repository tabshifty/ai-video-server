...
> 状态：已被 `0018-tv-long-form-ott-playback-session.md` 取代。`0013-tv-long-form-exoplayer-unification.md` 先撤销了混合内核前提，`0018` 进一步把电视剧专属共享控制层升级为电影、`18+` 与电视剧共用的统一播放会话和能力驱动控制层。
